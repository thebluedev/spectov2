...
const Navbar = () => {
  ...
  return (
    <nav className="absolute w-full z-[70] text-white flex items-center justify-between backdrop-blur border-solid border-0 border-b-[0.05px] border-[#ffffff2a]">
      ...
      <div className="hidden md:block">
        <button className="transition-colors duration-500 bg-[#dd5061] hover:bg-[#ffffff] hover:text-black text-white font-bold rounded-none flex items-center h-16 px-[5em]">
          Shop
        </button>
      </div>
      ...
      <div
        className={`${
          isOpen ? "block" : "hidden"
        } md:hidden w-full absolute top-20 left-0  text-white text-center backdrop-blur-sm z-[70]`}
      >
        <a
          href="#products"
